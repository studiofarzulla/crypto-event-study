...
# src/ lives under code/. The paper-side working copy keeps data/ at
# code/data/; in this public repo it sits at the repo root (next to code/).
# Resolve whichever exists — the files are byte-identical in both layouts.
...
BOOTSTRAP_METHOD = 'percentile'  # Percentile CIs (see src/robustness.py); matches reported results
