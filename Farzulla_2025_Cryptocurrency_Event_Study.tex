...
Parameter estimation enforces covariance stationarity via inequality constraints ($\alpha + \beta + |\gamma|/2 < 0.999$), with all six cryptocurrencies converging to the stationarity boundary ($\alpha+\beta \approx 0.999$), suggesting near-integrated variance dynamics characteristic of cryptocurrency markets. Substantial cross-sectional heterogeneity exists within infrastructure sensitivity, ranging from ADA (3.371\%) to BTC (1.191\%), a 2.18 percentage point spread. Raw significance (p < 0.05) holds for 5 of 6 cryptocurrencies for infrastructure events versus 0 of 6 for regulatory events, with only ETH infrastructure effect surviving FDR correction (q < 0.10).
