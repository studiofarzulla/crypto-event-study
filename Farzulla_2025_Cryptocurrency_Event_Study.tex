% ============================================================================
% DISSENSUS AI WORKING PAPER
% ============================================================================
% DAI-WP-2025-003
% Reformatted February 2026 for Dissensus AI Working Paper Series
% ============================================================================
...
% DAI metadata
\dai{2025}{003}
\programme{Cryptocurrency Microstructure Analysis}
\doidoi{10.21203/rs.3.rs-8323026/v1}
\correspondingauthor{murad@dissensus.ai}
\orcid{0009-0002-7164-8704}
\keywords{Cryptocurrency, Volatility, Event Study, TARCH-X, Infrastructure Events, Regulatory Events, GDELT, Market Microstructure, Risk Management}
\jelcodes{G12, G14, G15, G18, C22, C58}

\title{Infrastructure vs Regulatory Shocks: Asymmetric Volatility Response in Cryptocurrency Markets}
...
This paper originated as a Master's thesis submitted September 2025. Version 1.0.0 (published Zenodo November 2025) incorporated substantial statistical corrections and analytical revisions from the original thesis submission, with completely updated numerical results reflecting fresh analysis conducted November 10, 2025. This version adopts the Dissensus AI Working Paper Series format. All numerical results, statistical tests, figures, and tables remain identical to earlier versions, ensuring continuity for readers and citations.
...
This research was conducted under the Adversarial Systems \& Complexity Research Initiative (ASCRI) at Dissensus AI.
...
\vspace{0.5em}
\noindent\textbf{Methodologies:} Research methodologies and reproducibility practices are documented at \href{https://dissensus.ai}{\texttt{dissensus.ai}}.
